...
import { StyleSheet, FlatList, TouchableOpacity, View, TextInput, Image } from 'react-native';
...
const PRODUCTS = [
  { id: '1', name: 'Organic Fertilizer (Premium)', price: 'Rs. 2,500', seller: 'Green Agro', rating: 4.8, category: 'Fertilizers', badge: 'AI Pick' },
  { id: '2', name: 'Paddy Seeds (SL80 High Yield)', price: 'Rs. 1,800', seller: 'Lanka Seeds', rating: 4.5, category: 'Seeds', badge: 'Bestseller' },
  { id: '3', name: 'Manual Sprayer Pump (5L)', price: 'Rs. 5,200', seller: 'AgriTools', rating: 4.2, category: 'Tools' },
  { id: '4', name: 'Natural Pesticide Solution', price: 'Rs. 1,200', seller: 'BioFarm', rating: 4.7, category: 'Pesticides', badge: 'Eco Friendly' },
  { id: '5', name: 'Paddy Harvesting Sickle', price: 'Rs. 650', seller: 'Hardware Plus', rating: 4.9, category: 'Tools' },
  { id: '6', name: 'Hybrid Maize Seeds', price: 'Rs. 950', seller: 'AgriSeed Co.', rating: 4.3, category: 'Seeds' },
];
