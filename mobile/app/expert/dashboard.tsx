...
export default function ExpertDashboardScreen() {
    ...
    const QUICK_ACTIONS = [
        { id: 'queries', label: 'Answer Queries', icon: 'chatbubbles-outline', color: '#8B5CF6', route: '/(tabs)/expert-queries' },
            ...
            >
                <View style={styles.header}>
                    <View style={[styles.welcomeBox, { backgroundColor: C.primary }]}>
                        <View>
                            ...
                            <ThemedText style={styles.expertName}>Expert {user?.name}</ThemedText>
                        </View>
                ...
                <View style={styles.statsGrid}>
                    <View style={[styles.statBox, { backgroundColor: C.card, borderColor: C.border }]}>
                        ...
                        <ThemedText style={[styles.statLabel, { color: C.muted }]}>Pending Queries</ThemedText>
                    </View>
                    <View style={[styles.statBox, { backgroundColor: C.card, borderColor: C.border }]}>
                        <ThemedText style={[styles.statValue, { color: '#F59E0B' }]}>{stats.activeAlerts}</ThemedText>
                        <ThemedText style={[styles.statLabel, { color: C.muted }]}>Active Alerts</ThemedText>
                    </View>
                </View>

                <ThemedText style={[styles.sectionTitle, { color: C.muted }]}>QUICK ACTIONS</ThemedText>
                        ...
                        >
                            ...
                            <View style={styles.actionInfo}>
                                ...
                                <ThemedText style={[styles.actionDesc, { color: C.muted }]}>
                                    {action.id === 'queries' ? 'Help farmers with their crop issues' : 
                                     action.id === 'alerts' ? 'Post new agricultural advisories' : 
                                     'Manage your verified credentials'}
                                </ThemedText>
                            </View>
                    ...
                    <View style={[styles.impactBox, { backgroundColor: C.primaryDim, borderColor: C.primary + '30' }]}>
                        ...
                        <View style={{ flex: 1 }}>
                            ...
                            <ThemedText style={[styles.impactText, { color: C.subtext }]}>
                                Your advice has helped over 50 farmers this month. Keep up the great work!
                            </ThemedText>
                        </View>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    statsGrid: { flexDirection: 'row', gap: 12, paddingHorizontal: Spacing.lg, marginBottom: Spacing.xl },
    statBox: { flex: 1, padding: 16, borderRadius: Radius.lg, borderWidth: 1, alignItems: 'center', ...Shadows.xs },
    statValue: { fontSize: 24, fontWeight: '800' },
    statLabel: { fontSize: 11, fontWeight: '700', marginTop: 4, textTransform: 'uppercase' },
    sectionTitle: { fontSize: 12, fontWeight: '800', letterSpacing: 1, paddingHorizontal: Spacing.lg, marginBottom: 12 },
    actionsList: { paddingHorizontal: Spacing.lg, gap: 12 },
    actionCard: { flexDirection: 'row', alignItems: 'center', padding: 16, borderRadius: Radius.lg, borderWidth: 1, gap: 16, ...Shadows.sm },
    ...
    impactBox: { flexDirection: 'row', alignItems: 'center', padding: 20, borderRadius: Radius.lg, borderWidth: 1, gap: 16 },
    impactTitle: { fontSize: 16, fontWeight: '700' },
    impactText: { fontSize: 13, lineHeight: 18, marginTop: 4 }
});
